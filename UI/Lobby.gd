...
func _on_Host_pressed():
	...
	net.create_server(13975, 2)				# This Godot instance will host the game (i.e., be the server). It will connect on TCP/UDP port 13458, and it can host 4095 possible connections
...
func _on_Join_pressed():
	...
	net.create_client("127.0.0.1", 13975)		# This Godot instance will join an existing game. 127.0.0.1 (localhost) means to connect to this computer on port 13458
	get_tree().set_network_peer(net)
